...
# Created by DBIx::Class::Schema::Loader v0.07049 @ 2020-03-09 12:21:56
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:V70mJ51u/niZxcEzrgiPlA
...
sub js_callback {
	...
	my $backlink = '';
	my $resBook = DB->ResultSet('Book')->search({ cover => $cover->id });
	if ($resBook) {
		my $book = $resBook->next;
		$book->get_obalkyknih_url($secure);
	}
