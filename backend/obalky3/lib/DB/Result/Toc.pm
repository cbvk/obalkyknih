...
# Created by DBIx::Class::Schema::Loader v0.07049 @ 2020-04-02 10:11:26
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:96uBy3YhRa6QRNl/usoEvg
...
sub set_pdf {
	my($toc,$content,$tmpfile,$firstpage) = @_;
...
sub to_xml {
	...
	my $metadataChange = $product->book->metadata_change || $product->book->created;
	return "\t<book>\n".$bibinfoText.
			"\t\t<book_id>".$product->book->id."</book_id>\n".
